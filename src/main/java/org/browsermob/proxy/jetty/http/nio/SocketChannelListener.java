...
public class SocketChannelListener extends ThreadPool implements HttpListener
{
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see org.browsermob.proxy.jetty.http.HttpListener#setHttpServer(org.browsermob.proxy.jetty.http.HttpServer)
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see org.browsermob.proxy.jetty.http.HttpListener#customizeRequest(org.browsermob.proxy.jetty.http.HttpConnection, org.browsermob.proxy.jetty.http.HttpRequest)
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see org.browsermob.proxy.jetty.http.HttpListener#persistConnection(org.browsermob.proxy.jetty.http.HttpConnection)
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see org.browsermob.proxy.jetty.http.HttpListener#isIntegral(org.browsermob.proxy.jetty.http.HttpConnection)
     */
    ...
    /* ------------------------------------------------------------------------------- */
    /*
     * @see org.browsermob.proxy.jetty.http.HttpListener#isConfidential(org.browsermob.proxy.jetty.http.HttpConnection)
     */

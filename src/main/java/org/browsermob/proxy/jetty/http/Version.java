...
public class Version
{
    private static boolean __paranoid = 
        Boolean.getBoolean("org.browsermob.proxy.jetty.http.Version.paranoid");
    ...
    public static void main(String[] arg)
    {
        ...
        System.out.println("org.browsermob.proxy.jetty.http.Version="+__Version);
        System.out.println("org.browsermob.proxy.jetty.http.VersionImpl="+__VersionImpl);
        System.out.println("org.browsermob.proxy.jetty.http.VersionDetail="+__VersionDetail);
    }

...
public class ServletHttpContext extends HttpContext
{
    ...
    /* ------------------------------------------------------------ */
    /* 
     * @see org.browsermob.proxy.jetty.http.HttpContext#enterContextScope(org.browsermob.proxy.jetty.http.HttpRequest, org.browsermob.proxy.jetty.http.HttpResponse)
     */

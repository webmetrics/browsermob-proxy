...
public class ServletHandler extends Container implements HttpHandler
{
        ...
        throws Exception
    {
        ...
        _contextLog = LogFactory.getLog("org.browsermob.proxy.jetty.jetty.context."+getHttpContext().getHttpContextName());
    ...
    class Context implements ServletContext
    {
        ...
        {        
            ServletHandler handler= (ServletHandler)
                ...
                .findHandler(org.browsermob.proxy.jetty.jetty.servlet.ServletHandler.class,
                             uri,
